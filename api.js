...
app.post("/siswa", (req,res) => {
    ...
    db.query(sql, data, (error, result) => {
        ...
        if (error) {
            ...
            response = {
                message: result.affectedRows + " data siswa telah ditambahkan"
            }
        }
        res.json(response) // send response
    })
...
app.put("/siswa", (req,res) => {
    ...
    db.query(sql, data, (error, result) => {
        ...
        if (error) {
            ...
            response = {
                message: result.affectedRows + " data siswa telah diperbarui"
            }
        }
        res.json(response) // send response
    })
...
app.delete("/siswa/:id", (req,res) => {
    ...
    db.query(sql, data, (error, result) => {
        ...
        if (error) {
            ...
            response = {
                message: result.affectedRows + " data siswa telah dihapus"
            }
        }
        res.json(response) // send response
    })
...
app.post("/pelanggaran", (req,res) => {
    ...
    db.query(sql, data, (error, result) => {
        ...
        if (error) {
            ...
            response = {
                message: result.affectedRows + " data pelanggaran telah ditambahkan"
            }
        }
        res.json(response) // send response
    })
...
app.put("/pelanggaran", (req,res) => {
    ...
    db.query(sql, data, (error, result) => {
        ...
        if (error) {
            ...
            response = {
                message: result.affectedRows + " data pelanggaran telah diperbarui"
            }
        }
        res.json(response) // send response
    })
...
app.delete("/pelanggaran/:id", (req,res) => {
    ...
    db.query(sql, data, (error, result) => {
        ...
        if (error) {
            ...
            response = {
                message: result.affectedRows + " data pelanggaran telah dihapus"
            }
        }
        res.json(response) // send response
    })
...
app.post("/user", (req,res) => {
    ...
    db.query(sql, data, (error, result) => {
        ...
        if (error) {
            ...
            response = {
                message: result.affectedRows + " data user telah ditambahkan"
            }
        }
        res.json(response) // send response
    })
...
app.put("/user", (req,res) => {
    ...
    db.query(sql, data, (error, result) => {
        ...
        if (error) {
            ...
            response = {
                message: result.affectedRows + " data user telah diperbarui"
            }
        }
        res.json(response) // send response
    })
...
app.delete("/user/:id", (req,res) => {
    ...
    db.query(sql, data, (error, result) => {
        ...
        if (error) {
            ...
            response = {
                message: result.affectedRows + " data user telah dihapus"
            }
        }
        res.json(response) // send response
    })
        ...
        if (error) {
            ...
            db.query(sql, [data], (error, result) => {
                if (error) {
                    ...
                    res.json({message: "Data pelanggaran siswa telah ditambahkan"})
                }
            })
        }
    })
        ...
        if (error) {
            ...
            db.query(sql, param, (error, result) => {
                if (error) {
                    ...
                    res.json({message: "data pelanggaran siswa telah dihapus"})
                }
            })
        }
    })
...
app.listen(8000, () => {
    console.log("Pelanggaran Siswa Node API")
})